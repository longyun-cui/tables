...
<div class="box-body column-container column-option">
    ...
    <form action="" method="post" class="form-horizontal form-bordered form-edit-column">
        ...
        <input type="hidden" readonly name="row_id" value="{{$row_encode or encode(0)}}">
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                ...
                <input type="hidden" name="column[{{$column->id}}][content_id]" value="{{$column->content->id or ''}}">
                <input type="text" class="form-control" name="column[{{$column->id}}][value]" placeholder="" value="{{$column->content->content or ''}}">
            </div>
        </div>
        @endforeach
